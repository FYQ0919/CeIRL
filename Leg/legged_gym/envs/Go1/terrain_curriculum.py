...
class TerrainCurriculum:
    ...
    def __init__(self,env:LeggedRobot,terrain:Customized_Terrain, cfg:BasicCfg,device) -> None:
        ...
        self.terrain_levels = torch.randint(cfg.terrain.min_init_terrain_level, cfg.terrain.max_init_terrain_level+1, (self.num_envs,), device=self.device)
    ...
    def update_curriculum(self,env_ids):
        ...
        move_down = move_down * (torch.abs(self.env.commands[env_ids, 2].squeeze(-1)) < 0.15)
